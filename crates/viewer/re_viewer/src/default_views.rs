...
fn populate_view_class_registry_with_builtin(
    ...
    view_class_registry.add_class::<crate::ui::HoudiniGalleryView>(
        reflection,
        app_options,
        fallback_registry,
    )?;
    ...
    view_class_registry.add_class::<crate::ui::HoudiniShelfView>(
        reflection,
        app_options,
        fallback_registry,
    )?;
    view_class_registry.add_class::<crate::ui::HoudiniExecutionView>(
        reflection,
        app_options,
        fallback_registry,
    )?;
