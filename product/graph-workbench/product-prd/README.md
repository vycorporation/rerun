...
This directory is the fork-local product source for the graph workbench product fork.
...
Current implementation docs in `product/graph-workbench/` and GitHub issues are the active planning surfaces.
