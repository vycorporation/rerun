...
| Node duplication and deletion | partial; selected-set duplication and internal wiring landed, clipboard/reconnect polish deferred | `node-duplication.md`, command-history tracker | `#92`, `#108`, `#113`, `#284`, `#286` |
