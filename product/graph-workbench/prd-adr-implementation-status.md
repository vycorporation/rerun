...
| Native plugin operator lane | partial | `native-plugin-operator-lane.md` | `#34`, `#51`, `#52`, `#53`, `#54`, `#270`, `#272`, `#274`, `#276`, `#278` |
...
7. Plugin capability and trust policy hardening.
   ...
   - Later likely slices: modal project trust prompts and richer loader/runtime
     recovery actions.
