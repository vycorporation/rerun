...
| Procedural asset interface | partial | `procedural-asset-interface.md` | `#33`, `#47`, `#48`, `#49`, `#50`, `#61`, `#152`, `#156` |
...
2. Procedural asset authoring depth.
   ...
   - Issue-backed slices: `#152` promoted parameter binding metadata, `#156` match-definition and upgrade-to-current-definition model actions.
   - Later likely slices: typed asset input/output boundary editing, save-definition actions, and artifact-reference warnings.
