...
| Graph hierarchy and named graph registry | partial | `graph-hierarchy-tracker.md` | `#130`, `#131`, `#132`, `#142`, `#144`, `#146`, `#148`, `#164`, `#166`, `#168`, `#170`, `#172`, `#174`, `#176`, `#178` |
...
| Dataset/source breadth and external artifact references | partial | `dataset-source-breadth-tracker.md` | `#196`, `#198`, `#200`, `#202`, `#204`, `#206`, `#208` |
...
4. Dataset/source breadth and external artifact references.
   ...
   - Issue-backed slices: `#196` source locator metadata model, `#198` source format capability records, `#200` source external-reference status reports, `#202` source bundle preview metadata, `#204` focused dataset/source tracker, `#206` source package manifest preview records, and `#208` source format inference reports.
   - Later likely slices: package/export manifest writing.
