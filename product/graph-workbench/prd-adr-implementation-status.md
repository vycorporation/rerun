...
| Node duplication and deletion | partial; selected-set duplication, internal wiring, and clipboard paste landed; reconnect polish deferred | `node-duplication.md`, command-history tracker | `#92`, `#108`, `#113`, `#284`, `#286`, `#290` |
