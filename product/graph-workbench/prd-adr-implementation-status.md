...
| Dataset/source breadth and external artifact references | partial | `dataset-source-breadth-tracker.md` | `#196`, `#198`, `#200`, `#202`, `#204` |
...
4. Dataset/source breadth and external artifact references.
   ...
   - Issue-backed slices: `#196` source locator metadata model, `#198` source format capability records, `#200` source external-reference status reports, `#202` source bundle preview metadata, and `#204` focused dataset/source tracker.
