...
| Connection editing semantics | partial | this ledger until a focused tracker is added | `#136`, `#137`, `#138`, `#180` |
...
3. Connection editing semantics.
   ...
   - Issue-backed slices: `#136` explicit graph edge metadata spine, `#137` acyclic edge validation, `#138` connection diagnostics, and `#180` graph-owned data-flow edge add action.
