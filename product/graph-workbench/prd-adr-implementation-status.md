...
| Node duplication and deletion | partial; selected-set duplication landed, clipboard/wiring polish deferred | `node-duplication.md`, command-history tracker | `#92`, `#108`, `#113`, `#284` |
