...
| Graph hierarchy and named graph registry | partial | `graph-hierarchy-tracker.md` | `#130`, `#131`, `#132`, `#142`, `#144`, `#146`, `#148`, `#164`, `#166`, `#168`, `#170`, `#172`, `#174`, `#176`, `#178`, `#216`, `#220`, `#222`, `#224`, `#226`, `#228`, `#230`, `#288` |
...
| Node duplication and deletion | partial; selected-set duplication, internal wiring, clipboard paste, and external reconnect paste choices landed | `node-duplication.md`, command-history tracker | `#92`, `#108`, `#113`, `#284`, `#286`, `#290`, `#292` |
...
1. Multiple named graphs and subgraph navigation.
   ...
   - Later likely slices: explicit connection-editing cycle blocking and asset-definition polish after manual subnet creation QA.
...
7. Plugin capability and trust policy hardening.
   ...
   - Issue-backed slices: `#270` model-owned native operator trust controls
     for project trust, per-operator enablement, and capability grants, and
     `#272` inspector controls that route those trust changes through the
     graph-owned commands, `#274` missing capability grant diagnostics, and
     `#276` typed native operator failure diagnostics with bounded detail text,
     and `#278` inspector recovery actions for retrying or dismissing current
     native failure diagnostics, and `#280` project trust confirmation prompts.
   - Later likely slices: richer loader/runtime recovery actions.
