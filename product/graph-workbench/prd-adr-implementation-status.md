...
| Procedural asset interface | partial | `procedural-asset-interface.md` | `#33`, `#47`, `#48`, `#49`, `#50`, `#61`, `#152`, `#156`, `#158` |
...
2. Procedural asset authoring depth.
   ...
   - Issue-backed slices: `#152` promoted parameter binding metadata, `#156` match-definition and upgrade-to-current-definition model actions, `#158` external artifact reference metadata and warnings.
   - Later likely slices: typed asset input/output boundary editing, save-definition actions, and bundle/export artifact inclusion previews.
